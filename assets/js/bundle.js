...
module.exports = function () {
  ...
  return {
    ...
    sendColorToDevice: function sendColorToDevice(color) {
    ...
    getColor: function getColor(chord, condition) {
      var self = this,
          color;
    ...
    bindEvents: function bindEvents() {
      ...
      var colorOutputElement = document.querySelector('#colorOutput');
...
},{"axios":4,"file-saver":30}],2:[function(require,module,exports){
"use strict";
